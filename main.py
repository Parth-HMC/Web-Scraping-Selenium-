...
all_data = pd.DataFrame(columns=["Organization Name", "Industry", "No. of Employees", "Certification Period", "Profile URL"])
...
while True:
    try:
        ...
        print(f"Scraping completed with error: {e}")
        break

csv_path = "Great_Place_to_Work.csv"
all_data.to_csv(csv_path, index=False)
print("Scraping completed successfully! Data saved as Great_Place_to_Work.csv")
